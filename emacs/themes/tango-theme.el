...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(linum ((,class (:foreground ,alum-3 :background ,alum-1))))
   ;; Mode line faces
   `(mode-line ((,class (:box (:line-width 1) :background ,alum-2 :foreground ,alum-6))))
   `(mode-line-inactive ((,class (:box (:line-width 1) :background ,alum-3 :foreground ,alum-6))))
   `(mode-line-buffer-name ((,class (:foreground ,blue-1 :weight bold))))
   `(mode-line-mode-face ((,class (:foreground ,plum-2))))
   `(mode-line-folder-face ((,class (:foreground ,alum-4))))
   `(mode-line-modified-face ((,class (:foreground ,orange-2))))
   `(mode-line-read-only-face ((,class (:foreground ,red-1))))
