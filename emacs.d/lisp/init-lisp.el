...
;; invocation.
(advice-add #'pp-display-expression
            :after (lambda (_ out-buffer-name)
...
(use-package slime-company
  :after slime company
  :preface (defun ngq/company-activate-slime ()
             (push 'slime-company slime-contribs)
             (slime-setup)
             (ngq/company-activate-local-backend 'company-slime))
  :hook ((slime-repl-mode . ngq/company-activate-slime)
