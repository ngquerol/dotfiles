...
local layouts =
  ...
  vicious.register(datewidget, vicious.widgets.date, " %d/%m/%y, %R ", 59)
  ...
  gmailicon:buttons(awful.util.table.join(
		      awful.button({ }, 1, function () awful.util.spawn(browser .. " https://mail.google.com/mail/")
					   end)))
  ...
  vicious.register(cpuwidget_text, vicious.widgets.cpu,
		   function (widget, args)
		     if args[1] >= 75 then
		       return "<span weight='bold' color='#E84F4F'> " .. args[2] .. "%</span> · <span weight='bold' color='#E84F4F'>"  .. args[3] ..  "%</span> "
		     else
  ...
  local thermalwidget_1 = wibox.widget.background()
  local thermalwidget_2 = wibox.widget.background()
  local thermalwidget_1_text = wibox.widget.textbox()
  local thermalwidget_2_text = wibox.widget.textbox()
  vicious.register(thermalwidget_1_text, vicious.widgets.thermal,
		   function (widget, args)
		     if args[1] >= 70 then
		   ...
		   end, 19, {"coretemp.0", "core", "temp2_input"})
  thermalwidget_1:set_widget(thermalwidget_1_text)
  vicious.register(thermalwidget_2_text, vicious.widgets.thermal,
		   function (widget, args)
		     if args[1] >= 70 then
		       return "<span color='#E84F4F'><b> " .. args[1] .. "°C </b></span>"
		     else
		   ...
		   end, 19, {"coretemp.0", "core", "temp3_input"})
  thermalwidget_2:set_widget(thermalwidget_2_text)
  ...
  vicious.register(mpdwidget, vicious.widgets.mpd,
		   function (widget, args)
		     ...
		     elseif args["{state}"] == "Play" then
		       return "<span color='#7AC82E'>" .. args["{Title}"]..'</span> - '.. args["{Artist}"]
		     else
		       return ""
		     end
		   end, 7)
  ...
  local netwidget = wibox.widget.background()
  local netwidget_text = wibox.widget.textbox()
  vicious.register(netwidget_text, vicious.widgets.net,
		   "<span foreground='#7AC82E'> ${wlan0 up_kb}</span> <span foreground='#46A8C3'>${wlan0 down_kb}</span> ", 3)
  netwidget:set_widget(netwidget_text)
  netwidget:set_bg("#313131")
  ...
  for s = 1, screen.count() do
    ...
    right_layout:add(thermalwidget_1)
    right_layout:add(thermalwidget_2)
    right_layout:add(arrl_ld)
